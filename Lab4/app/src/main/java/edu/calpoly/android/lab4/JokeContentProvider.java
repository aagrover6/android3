...
public class JokeContentProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		Log.d("aagrover ", "uriType is " + uriType);
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch (uriType) {
			...
			case JOKE_ID:
				...
				rowsDeleted = sqlDB.delete(JokeTable.DATABASE_TABLE_JOKE, JokeTable.JOKE_KEY_ID + "=" + jokeID, null);
				break;
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		switch (uriType) {
			...
			case JOKE_ID:
				String jokeID = uri.getLastPathSegment();
				updated = sqlDB.update(JokeTable.DATABASE_TABLE_JOKE, values, JokeTable.JOKE_KEY_ID + "=" + jokeID, null);
				break;
